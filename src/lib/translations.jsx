...
export const translations = {
  es: {
    ...
    // Scrap & Quality Common
    scrapReport: "Reporte de Scrap",
    scrapQuantity: "Cantidad Scrap",
    ...
    registerScrap: "Registrar Scrap",
    scrapRegistered: "Scrap registrado",
    
    // WIP & Inventory
    wipBalance: "Balance WIP",
    reserved: "Reservado",
    ...
    partNumbersTitle: "Números de Parte",
    ...
    qualityDashboard: "Dashboard Calidad",
    newInspection: "Nueva Inspección",
    inspectionDetail: "Detalle Inspección",
    piecesReviewed: "Piezas Revisadas",
    approvedPieces: "Piezas Aprobadas",
    rejectedPieces: "Piezas Rechazadas",
    defectsFound: "Defectos Encontrados",
    observations: "Observaciones",
    suggestedDecision: "Decisión Sugerida",
    defectRate: "Tasa de Defectos",
    calculateGrade: "Calificar",
    saveInspection: "Guardar Inspección",
    totalInspections: "Total Inspecciones",
    registro: "registros",
    records: "Registros",
    registros: "Registros",
    aprobadas: "Aprobadas",
    rechazadas: "Rechazadas",
    requierenAccion: "requieren acción",
    inspectionsToday: "Inspecciones Hoy",
    inspeccionesHoy: "Inspecciones Hoy",
    pendingInspections: "Pendientes",
    porRevisar: "por revisar",
    approvalRate: "Tasa Aprobación",
    tasaAprobacion: "Tasa de Aprobación",
    rejectionRate: "Tasa Rechazo",
    tasaRechazo: "Tasa de Rechazo",
    qualityIndicators: "Indicadores Calidad",
    indicadoresCalidad: "Indicadores de Calidad",
    historical: "histórico",
    historico: "histórico",
    incidents: "incidentes",
    allDispositions: "Todas las disposiciones",
    qualityInspector: "Inspector Calidad",
    totalScrap: "Total Scrap",
    scrapHoy: "Scrap Hoy",
    piezas: "piezas",
    piezasRechazadas: "piezas rechazadas",
    defectoPrincipal: "Defecto Principal",
    ...
    approved: "Aprobada",
    rejected: "Rechazada",
    conditional: "Aprobada Condicional",
    parts: "registros",
    inspectorLabel: "Inspector",
    quantityLabel: "Cantidad",
    notesPlaceholder: "Notas adicionales...",
    calculateFirst: "Calcula primero los resultados",
    sumError: "La suma debe ser igual al total",
    fillRequired: "Complete los campos obligatorios",
    saveRecord: "Guardar Registro",
    partNumberLabel: "Núm. Parte",
    descriptionLabel: "Descripción",
    quantityLabelRequired: "Cantidad *",
    defectTypeRequired: "Tipo Defecto *",
    operatorLabel: "Operador",
    dispositionLabel: "Disposición",
    inspectorLabelRequired: "Inspector",
    rootCauseLabel: "Causa Raíz",
    rootCausePlaceholder: "¿Por qué ocurrió el defecto?",
    correctiveActionLabel: "Acción Correctiva",
    correctiveActionPlaceholder: "¿Qué se hizo para corregir?",
    selectOption: "Seleccionar...",
    moduleTitle: "Control de Calidad",
